;;; color-theme-buffer-local-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "color-theme-buffer-local" '("color-theme-buffer-local-"))
